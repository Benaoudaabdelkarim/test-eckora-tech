    ...
    return (
        <div className="">
            <div className="flex flex-col justify-center items-center h-80 bg-gray-100 ">
                <h1 className="text-xl md:text-3xl primary-text font-semibold">Nos Services Municipaux</h1>
                <p className="max-w-xl text-sm md:text-xl font-medium mt-4 md:mt-6 text-center">
            ...
            <div className="mx-6 md:mx-auto py-12 max-w-4xl lg:max-w-7xl">
                ...
                <div className="mt-10">
                    <h2 className="text-xl md:text-2xl font-medium">Divisions administratives :</h2>
